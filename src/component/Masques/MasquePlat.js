    ...
    const onSubmit = (e) =>{
        ...
        if (document.getElementById('titre_modal').textContent==='Ajouter') {
            ...
            const enregistrerAjout  = async () => {
                ...
                const response = await fetch("http://localhost:5000/ajout/"+baseTable.bdd+"/"+baseTable.table_name,{
                  method : 'POST',
                        ...
                        {is_resume===true
                            ...
                            :<Fragment>
                               <tr>
                                ...
                                <td>
                                <span id = 'statut-enregistrement'> Donnees inserees avec success</span>       
                                </td>
                                </tr>
