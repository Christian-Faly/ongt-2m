...
export default function InsertMaitre(tabla,critere,gMaitre){
    ...
    function afficher2() {          
        ...
        if (critere===undefined)
            OuvrirSimpleElement(tabla.bdd,tabla.tab,true,tabla.idToSelect) //bdd,tab,true 
        else{
            OuvrirSimpleCritere(tabla.bdd, tabla.tab,true,critere.champ,critere.valeur,tabla.idToSelect)//,
        }
