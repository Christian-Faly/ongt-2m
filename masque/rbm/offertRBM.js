...
import OffertRBMForm from './offertRBMForm';
import * as SQLite from 'expo-sqlite';

export default function OffertRBM({ route, navigation }) {
      ...
      <Modal visible={saisieOffert} animationType='slide'>
        <TouchableWithoutFeedback onPress={Keyboard.dismiss}>
          <View style={styles.modalContent}>
            ...
            />
            <OffertRBMForm passOffert={{dataPass,add:addOffert, update:updateOffert}} />
          </View>
