...
import OffertAUEForm from './offertAUEForm';
import * as SQLite from 'expo-sqlite';

export default function OffertAUE({ route, navigation }) {
      ...
      <Modal visible={saisieOffert} animationType='slide'>
        <TouchableWithoutFeedback onPress={Keyboard.dismiss}>
          <View style={styles.modalContent}>
            ...
            />
            <OffertAUEForm passOffert={{dataPass,add:addOffert, update:updateOffert}} />
          </View>
