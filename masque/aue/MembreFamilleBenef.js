...
export default function MembreFamilleBenefAUE({ route, navigation }) {
  ...
  useEffect(()=>{
    ...
    db.transaction((tx) => {
        //  tx.executeSql("DROP TABLE membre_famille_aue",
        tx.executeSql("CREATE TABLE IF NOT EXISTS membre_famille_aue"+
