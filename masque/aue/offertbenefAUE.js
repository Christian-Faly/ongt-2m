...
import OffertBenefAUEForm from './offertBenefAUEForm';
import * as SQLite from 'expo-sqlite';

export default function OffertBenefAUE({ route, navigation }) {
      ...
      <Modal visible={saisieOffert} animationType='slide'>
        <TouchableWithoutFeedback onPress={Keyboard.dismiss}>
          <View style={styles.modalContent}>
            ...
            />
            <OffertBenefAUEForm passOffert={{dataPass,add:addOffert, update:updateOffert}} />
          </View>
