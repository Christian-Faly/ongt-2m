 ...
 let lstSexe =[
  ...
  const submitForm = () => {
    ...
    if (isValidDate(form.debut_activite)===true){
      ...
      pass.dataPass.setSaisiePMA(false)
    }else{
  ...
  return (
   <View style={FormStyles.container}> 
      ...
      <Text style={FormStyles.paragraph}>Saisie fabriquant petit matériel agricole  </Text>
      </Card>
      ...
      {/*ncommune, fokontany, site TEXT, coo_x TEXT, coo_y TEXT, nom_pepineriste TEXT, sexe TEXT, date  */}
        ...
        <View>
        <Text style={FormStyles.label}>Nom fabricant</Text>
        <TextInput  style={FormStyles.input}
                    name="nom_fabricant"
                    onChangeText={(value) => handleForm('nom_fabricant', value)}
                    value = {form.nom_fabricant}
        />
