...
// BenefAUE == VentePMA
export default function VentePMAForm({ pass}) {
  ...
  return (
   <View style={FormStyles.container}> 
      ...
      <Card style={FormStyles.card}>
        <Text style={FormStyles.paragraph}>Saisie Vente petit matériel agricole </Text>
      </Card>
      <Text style={FormStyles.label}></Text>
        ...
        <View>
          ...
          <Text style={FormStyles.label}>Designation matériel vendu</Text>
          <TextInput  style={styles.input}
                    id="pma_vendue"
                    name="pma_vendue"
                    onChangeText={(value) => handleForm('pma_vendue', value)}
                    value = {form.pma_vendue}
          />
          <View>
