...
import OffertAUPForm from './offertAUPForm';
import * as SQLite from 'expo-sqlite';

export default function OffertAUP({ route, navigation }) {
      ...
      <Modal visible={saisieOffert} animationType='slide'>
        <TouchableWithoutFeedback onPress={Keyboard.dismiss}>
          <View style={styles.modalContent}>
            ...
            />
            <OffertAUPForm passOffert={{dataPass,add:addOffert, update:updateOffert}} />
          </View>
