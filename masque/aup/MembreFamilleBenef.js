...
export default function MembreFamilleBenefAUP({ route, navigation }) {
  ...
  useEffect(()=>{
    ...
    db.transaction((tx) => {
        //  tx.executeSql("DROP TABLE membre_famille_aup",
        tx.executeSql("CREATE TABLE IF NOT EXISTS membre_famille_aup"+
