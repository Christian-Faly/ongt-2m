...
export default function paysanSemForm({ pass}) {
  ...
  return (
   <View style={FormStyles.container}> 
      ...
      <Text style={FormStyles.paragraph}>Saisie PPS </Text>
      </Card>
      ...
      {/*ncommune, fokontany, site TEXT, coo_x TEXT, coo_y TEXT, nom_pepineriste TEXT, sexe TEXT, date  */}
        ...
        <View>
        <Text style={FormStyles.label}>nom PPS</Text>
        <TextInput  style={FormStyles.input}
                    name="nom_pps"
                    onChangeText={(value) => handleForm('nom_pps', value)}
                    value = {form.nom_pps}
        />
