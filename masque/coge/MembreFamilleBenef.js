...
export default function MembreFamilleBenefCOGE({ route, navigation }) {
  ...
  useEffect(()=>{
    ...
    db.transaction((tx) => {
        //  tx.executeSql("DROP TABLE membre_famille_coge",
        tx.executeSql("CREATE TABLE IF NOT EXISTS membre_famille_coge"+
