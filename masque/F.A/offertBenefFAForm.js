...
export default function OffertBenefFAForm({ passOffert }) {
  ...
  passOffert.dataPass.lstDesignation.forEach(item => {
    lstOffert = [...lstOffert,{categorie:item.categorie,key:item.designation,value:item.designation}]  
  }) 
  ...
  return (
    ...
    <Text style={FormStyles.paragraph}>Saise dotation bénéficiaire foyer améliorer  </Text>
    </Card>
