...
export default function MembreFamilleBenefFA({ route, navigation }) {
  ...
  useEffect(()=>{
    ...
    db.transaction((tx) => {
        //  tx.executeSql("DROP TABLE membre_famille_fa",
        tx.executeSql("CREATE TABLE IF NOT EXISTS membre_famille_fa"+
